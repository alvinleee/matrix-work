...
func (b *EthAPIBackend) FetcherNotify(hash common.Hash, number uint64) {
	...
	for _, id := range ids {
		...
		b.eth.protocolManager.fetcher.Notify(id.String(), hash, number, time.Now(), peer.RequestOneHeader, peer.RequestBodies)
